...
// Assuming this is in your front-end JavaScript code
...
async function signUp() {
  ...
  const emailAddress = document.querySelector('.EmailUser').value;
...
signInButton.addEventListener('click', login); // Use a different function name for login
